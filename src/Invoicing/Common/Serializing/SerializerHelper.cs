...
public class SerializerHelper
{
    ...
    public static void ConfigureSettingsForPayroll(PayrollVersion version = PayrollVersion.V12)
    {
        throw new NotImplementedException("ConfigureSettingsForPayroll");
    }

    public static void ConfigureSettingsForWaybill(WaybillVersion version = WaybillVersion.V20)
    {
        throw new NotImplementedException("ConfigureSettingsForWaybill");
    }
}